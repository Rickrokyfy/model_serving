...
instance_prod = nova.servers.create(name="prod_server_with_docker_rikard_ahlkvist"+str(identifier), image=image, flavor=flavor, key_name='Dangen',userdata=userdata_prod, nics=nics,security_groups=secgroups)
instance_dev = nova.servers.create(name="dev_server_rikard_ahlkvist"+str(identifier), image=image, flavor=flavor, key_name='Dangen',userdata=userdata_dev, nics=nics,security_groups=secgroups)
